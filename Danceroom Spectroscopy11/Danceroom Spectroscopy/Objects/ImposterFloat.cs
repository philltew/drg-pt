...
{
	public class ImposterFloat : IResourceManager 
	{
		...
		public void Render(float brightPassThreshold)
		{
			Effect.RenderImposter(m_OverlayType, m_ImposterTextureView, brightPassThreshold);
		}

...
BlendState AdditiveBlending
{
	...
	DestBlend =	ONE;
	BlendOp	= ADD;
	SrcBlendAlpha =	ONE; // SRC_ALPHA; // INV_DEST_ALPHA; // SRC_ALPHA; // ONE; // SRC_ALPHA; // ONE; // SRC_ALPHA;
	DestBlendAlpha = ONE; // INV_SRC_ALPHA; // DEST_ALPHA; // INV_SRC_ALPHA; // ONE; // INV_SRC_ALPHA; // ONE; // ZERO; // ONE; // INV_SRC_ALPHA;
    BlendOpAlpha = ADD;

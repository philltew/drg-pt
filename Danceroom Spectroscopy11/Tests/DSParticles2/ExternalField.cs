...
namespace DSParticles2
{
	public class ExternalField : ForceField
	{
		...
		double[] m_CalculateForceField_TempArray = new double[256];
		...
		public ExternalField(ParticleEnsemble ensemble)
		{
			...
			xforces = new double[ensemble.GetMaxNumberOfParticles()];
			yforces = new double[ensemble.GetMaxNumberOfParticles()];
		...
		public void ResizeForceArrays(ParticleEnsemble ensemble)
		{
			...
			// allocate vectors holding positions & forces
			xforces = new double[ensemble.GetNumberOfParticles()];
			yforces = new double[ensemble.GetNumberOfParticles()];
		}

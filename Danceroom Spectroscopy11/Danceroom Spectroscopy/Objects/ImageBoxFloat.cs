...
{
	public class ImageBoxFloat : IResourceManager
	{
		protected static ImposterFloatEffect Effect;
		...
		public ImageBoxFloat(string filename)
		{
			if (Effect == null)
			{
		...
		public void Render()
		{
			...
			Effect.RenderImposter(OverlayType, m_VerticesBindings, TextureView, m_Alpha); 
		}

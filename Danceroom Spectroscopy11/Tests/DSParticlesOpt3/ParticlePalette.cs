...
namespace DSParticlesOpt3
{
	public class ParticlePalette
	{
		...
		public readonly ParticleInfo[] Lookup; 
		...
		public bool AddParticleDefinition(string Name, double Mass, int Color, int MidiOutput, int Note)
		{
			if (m_Count < MAX_PARTICLE_TYPES) 
			{
				ParticleInfo info = new ParticleInfo(m_Count, Name, Mass); 

...
{
	public class ImageBoxFloatPalette : IResourceManager
	{
		protected static ImposterFloatPaletteEffect Effect;
		...
		public float Alpha { get { return m_Alpha; } set { m_Alpha = value; } }

		public ImageBoxFloatPalette(string filename)
		{
			if (Effect == null)
			{
				Effect = SharedEffects.Effects["ImposterFloatPalette"] as ImposterFloatPaletteEffect;
			}
		...
		public void Render()
		{
			...
			Effect.RenderImposter(OverlayType, m_VerticesBindings, TextureView, m_Alpha, Color); 
		}

...
using RugTech1.Framework.Capture;

namespace RugTech1.Win32.Avi
{
#if !__MonoCS__
	internal class UncompressedAVIWriter : IVideoWriter, IDisposable
	{		
		private IntPtr	file;
		...
		public UncompressedAVIWriter()
		{		
		}

		public UncompressedAVIWriter(string codec)
		{
			this.codec = codec;
		}

		// Desctructor
		~UncompressedAVIWriter()
		{
			Dispose(false);
		}

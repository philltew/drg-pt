...
namespace RugTech1.Framework.Objects.Simple
{
	public class ParticleRender : IResourceManager
	{
		...
		public ParticleRender(string particleTexture, int maxCount)
		{
			if (Effect == null)
			{
				Effect = SharedEffects.Effects["Particle"] as ParticleEffect; 
			}
		...
		public void Render(View3D view)
		{
			...
			Effect.Render(m_DataBindings, m_InstanceCount, viewProjWorld, m_ParticleTextureView, m_ColorScale, m_ParticleScale, m_MinDistance, m_MaxDistance, m_ScaleDistance); 
		}

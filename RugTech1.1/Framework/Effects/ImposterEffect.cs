...
{
	public enum ImposterOverlayType { None, Add, Subtract, Invert, Alpha, None_BrightPass, Add_BrightPass, Subtract_BrightPass, Alpha_BrightPass }

	public class ImposterEffect : BasicEffectBase
	{
		#region Private Members

		private string m_ShaderLocation = @"~/Shaders/Imposter.fx";
